-- Add short_id columns to existing tables for URL optimization
-- This will reduce URL length from ~80 characters to ~20 characters

-- Add short_id column to locations table
ALTER TABLE public.locations ADD COLUMN IF NOT EXISTS short_id TEXT;

-- Add short_id column to tables table  
